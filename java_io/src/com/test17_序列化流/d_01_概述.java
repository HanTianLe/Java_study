...
/**
 *  序列化流：把对象按照流一样的方式存入文本文件或者在网络中传输。       对象 -- 流数据(序列化流：ObjectOutputStream)
 *
 *  反序列化流:把文本文件中的流对象数据或者网络中的流对象数据还原成对象。 流数据 -- 对象(反序列化流：ObjectInputStream)
 *
 */
public class d_01_概述 {
