 ...
 * 该接口居然没有任何方法，类似于这种没有方法的接口被称为【标记接口】。
 *
 * java.io.InvalidClassException: com.test17_序列化流.Person;
 * local class incompatible:
 * stream classdesc serialVersionUID = -2071565876962058344,
 * local class serialVersionUID = 6918616181116917774
 *
 * 为什么会有问题呢?
...
public class Person implements Serializable{
    private static final long serialVersionUID = -2071565876962058344L;//自动产生的一个序列化id值。
    private String name;    //默认成员变量都是被序列化
//    private int age;
    private transient int age;  //表示该变量不需要被序列化（也就是它的值不能被记住）
//    int age;
